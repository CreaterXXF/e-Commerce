...
<font color="red">${requestScope.collectFail }</font>
    ...
    <div>
        <ul class="nav navbar-nav">
			...
			<li class="active"><a href="${pageContext.request.contextPath }/goCollect?user_id=${sessionScope.user.user_id }">查看收藏夹</a></li>
			<li><a href="#">我的订单</a></li>
            <li class="dropdown">
...
<tr>
<th width="10%">商品编号</th><th width="25%">商品名称 </th><th width="10%">商品价格</th><th width="30%">商品介绍</th><th align="center" width="25%">操作</th>
</tr>
<c:forEach items="${requestScope.collect_list }" var="collect">
<tr onmouseover="this.style.backgroundColor='#ffff66';" onmouseout="this.style.backgroundColor='#d4e3e5';">
 <td>${collect.good_id}</td>
 <td>${collect.good_name }</td>
 <td>${collect.good_price }</td>
 <td>${collect.good_introduce }</td>
 <td width="120px">&nbsp&nbsp&nbsp<a href="${pageContext.request.contextPath }/deleteCollect?good_id=${collect.good_id}">删除</a> </td>
</tr>
</c:forEach>
